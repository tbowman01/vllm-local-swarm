...
class AuthenticationMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        try:
            ...
            if self.config.required_permissions:
                if not await self.check_permissions(auth_info, self.config.required_permissions):
                    return JSONResponse(
    ...
    async def check_permissions(self, auth_info: dict, required_permissions: List[str]) -> bool:
